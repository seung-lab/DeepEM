...
class Sampler(object):
    ...
    def postprocess(self, sample):
        ...
        blv = np.concatenate((blv==1, blv==2), axis=-4)
        blv_msk = sample['blood_vessel_mask']
        blv_msk = np.concatenate((blv_msk, blv_msk), axis=-4)
        sample['blood_vessel'] = blv
